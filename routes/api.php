...
Route::get('/players', [CRUDController::class, 'index']);
Route::get('/players/all', [CRUDController::class, 'getAllPlayers']);
Route::get('/players/{id}', [CRUDController::class, 'getPlayerById']);
Route::post('/players', [CRUDController::class, 'newPlayer']);
Route::post('/players_logs', [CRUDController::class, 'createPlayerWithLog']);
